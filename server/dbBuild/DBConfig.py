...
DATA_PATH = r'E:\AnimeGameData-master\AnimeGameData-master'

# Dim的解包数据的TextMap文件夹位置，请在其中放置需要导入的语言json，并保持其TextMapXX.json的文件名不变
LANG_PATH = r'E:\AnimeGameData-master\AnimeGameData-master\TextMap'

# Dim的解包数据的Readable文件夹位置
READABLE_PATH = r'E:\AnimeGameData-master\AnimeGameData-master\Readable'
